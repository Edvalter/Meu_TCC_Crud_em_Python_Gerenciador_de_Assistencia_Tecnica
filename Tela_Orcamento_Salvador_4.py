...
class Funcao():
    ...
    def adiciona_Orcamento(self):
        ...
        self.cursor.execute("""                  
            INSERT INTO
                orcamentoteste (id_cliente, cpf, nome, whatsapp, produto, marca, modelo, cor, defeito, observacao) 
            VALUES 
                    (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);""",(self.id_cliente, self.cpf, self.nome, self.whatsapp, self.produto, self.marca, self.modelo, self.cor, self.defeito, self.observacao))
