...
class Aplicacao_Orcamento(Funcao):
    ...
    def labels_entry(self):
        ...
        self.l_produto = Label(self.frame_superior, text="Produdo:", font=("Courier", 13, "italic", "bold"), bg=co4, fg=co10)
        self.l_produto.place(x=15, y=110)
        self.e_produto = Entry(self.frame_superior, width=45, justify='left', relief='raised', bg=co2, fg=co10)
        self.e_produto.place(x=110, y=110)
