...
class Relatorio():
    ...
    def geraRelatorio(self):
        ...
        self.c.drawString(50, 700, 'Código: ' + self.nomeRelatorio)  # + self.codigoRel) se eu quiser fazer a concatenação é so colocar essa parte
        self.c.drawString(50, 670, 'Nome: ')
        self.c.drawString(50, 630, 'Telefone: ')
        self.c.drawString(50, 600, 'Data do Cadastro: ')

        self.c.setFont("Helvetica", 12)


        self.c.drawString(150, 630, self.whatsappRelatorio)
        self.c.drawString(150, 600, self.data_cadastroRelatorio)
...
class Aplicacao_Pessoas(Funcao_Pessoas, Relatorio):
    ...
    def botoes_tela_pessoas(self):
        ...
        self.b_imprimir = Button(self.frame_superior_pessoas, text="Imprimir", command=self.geraRelatorio, width=10,
                                font=('Ivy 8 bold'), bg=co9, fg=co2, relief=RAISED, overrelief=RIDGE)
        self.b_imprimir.place(x=800, y=200, height=40, width=100)
